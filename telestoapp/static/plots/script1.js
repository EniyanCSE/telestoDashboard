...
wellDropdown.addEventListener("change", function () {
  ...
  d3.csv("/NewWellDynamic-With_filled_NullValues.csv").then((data) => {
    ...
    const tooltipLinesGroup = svg
      .append("g")
      .attr("class", "tooltip-lines-group");

    const tooltipLineVertical = tooltipLinesGroup
      .append("line")
    ...
    listeningRect.on("mousemove", function (event) {
      ...
      tooltipLineVertical.style("display", "block");
      tooltipLineVertical
        .attr("x1", xPos)
        .attr("x2", xPos)
        .attr("y1", 0)
    ...
    listeningRect.on("mouseleave", function () {
      ...
      tooltipDiv.style("display", "none");
      tooltipLineVertical.style("display", "none");
    });
